...
% Input: string in 8601 isoformat, e.g. "2018-01-18T11:39:50.520000Z"
...
time_split = strsplit(iso_date_str,'Z');
time_split = time_split{1};
time_split = strsplit(time_split,'T');
the_date_str = [time_split{1},' ',time_split{2}];

dt = datetime(the_date_str,'InputFormat','yyyy-MM-dd HH:mm:ss.SSSSSS');
