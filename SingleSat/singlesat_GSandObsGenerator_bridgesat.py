...
cztl.writeGStext(all_fd,'Fairbanks 1',start_avail,end_avail,latitude=64.84,longitude=-147.65)
cztl.writeGStext(all_fd,'Hawaii 2',start_avail,end_avail,latitude=19.9,longitude=-155.58)
cztl.writeGStext(all_fd,'New Mexico 3',start_avail,end_avail,latitude=32.79,longitude=-106.33)
cztl.writeGStext(all_fd,'South America 4',start_avail,end_avail,latitude=-54.8,longitude=-66.2)
cztl.writeGStext(all_fd,'Norway 5',start_avail,end_avail,latitude=69.6483489,longitude=18.9529104)
cztl.writeGStext(all_fd,'Northern Africa 6',start_avail,end_avail,latitude=31.73,longitude=-6.7)
cztl.writeGStext(all_fd,'Hartebeestock 7',start_avail,end_avail,latitude=-25.64,longitude=28.08)
cztl.writeGStext(all_fd,'Middle East 8',start_avail,end_avail,latitude=24.73,longitude=46.54)
cztl.writeGStext(all_fd,'Australia 9',start_avail,end_avail,latitude=-25.53,longitude=115.16)
