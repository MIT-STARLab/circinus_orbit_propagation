...
info_string = ['created for ',num2str(num_sats),' satellite scenario from matlab script tundra_sats_generator_wrapper.m, using targets params file sheet ',targets_parameters_filename,'/',targets_parameters_sheetname,' and gs sheet ',gs_parameters_filename,'/',gs_parameters_sheetname,', for ',num2str(end_time_sec),' seconds with ',num2str(delta_t_sec),' seconds timestep'];
